<div class="notif-datapetugas" data-notifdatapetugas="<?= $this->session->flashdata('notif'); ?>"></div>
						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="table-container">
								<div class="t-header"><?= $title ?>
									<button class="btn btn-primary float-right mb-0" type="button" data-toggle="modal" data-target="#exampleModal">Tambah Petugas</button>
								</div>
									...
									<table id="basicExample" class="table custom-table">
										...
										<tbody>
											...
											<tr>
												...
												<td><?= $ptg['alamat'] ?></td>
												<td>
													<a class="hapus-petugas" href="<?= base_url("User/hapus_petugas/") ?><?= $ptg['id_user'] ?>"><button class="btn btn-danger"><span class="icon-trash-2"></span></button></a>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card-body">
        	<form action="<?= base_url('User/edit_petugas/') ?><?= $ptg['id_user'] ?>" method="POST">
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="card-body">
        	<form action="<?= base_url('User/submit_petugas') ?>" method="POST">
			<div class="form-group">
				<label>Nama Lengkap</label>
