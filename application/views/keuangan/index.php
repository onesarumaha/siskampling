						...
						<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
							...
							<div class="table-container">
								<div class="t-header"><?= $title ?>
									<button class="btn btn-primary float-right mb-0" type="button" data-toggle="modal" data-target="#exampleModal">+ Pemasukan</button>
								</div>
									...
									<table id="basicExample" class="table custom-table">
										...
										<tbody>
											...
											<tr>
													...
													<td>
														<a class="hapus-masuk" href="<?= base_url("Keuangan/hapus_masuk/") ?><?= $iu['id_keuangan'] ?>"><button class="btn btn-danger "><span class="icon-trash-2"></span></button></a>
